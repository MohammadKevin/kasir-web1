...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      document.cookie = `token=${accessToken}; path=/; max-age=60; SameSite=Lax`
      document.cookie = `userRole=${user.type}; path=/; max-age=60; SameSite=Lax`
      document.cookie = `user=${encodeURIComponent(JSON.stringify(user))}; path=/; max-age=60; SameSite=Lax`
